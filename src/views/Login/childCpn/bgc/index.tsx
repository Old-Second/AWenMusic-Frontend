    ...
    <BgcWrapper>
      <div className='page'>
        <div className='cta-container-images'>
          ...
          <div className='cta-singular-cell'>
            <div className='cta-internal-image-cont flip-1'>
              <div className='cta-even-image image-8'></div>
              {/*<div className='cta-odd-image image-9'></div>*/}
            </div>
          </div>
          ...
          <div className='cta-singular-cell'>
            <div className='cta-internal-image-cont flip-6'>
              <div className='cta-even-image image-2'></div>
              {/*<div className='cta-odd-image image-1'></div>*/}
            </div>
          </div>
